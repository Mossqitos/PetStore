...
public class PetStore {
    ...
    public PetStore() {
        Pet[] pets = {
                ...
                new Pet(2, new Category(1, "Dogs"), "Rex", Arrays.asList("url3", "url4"), Arrays.asList(new Tag(3, "tag3"), new Tag(4, "tag4")), "available"),
                new Pet(3, new Category(1, "Dogs"), "Max", Arrays.asList("url5", "url6"), Arrays.asList(new Tag(5, "tag5"), new Tag(6, "tag6")), "available"),
                new Pet(4, new Category(2, "Cats"), "Milo", Arrays.asList("url7", "url8"), Arrays.asList(new Tag(7, "tag7"), new Tag(8, "tag8")), "available"),
                new Pet(5, new Category(2, "Cats"), "Tiger", Arrays.asList("url9", "url10"), Arrays.asList(new Tag(9, "tag9"), new Tag(10, "tag10")), "available"),
                new Pet(6, new Category(3, "Birds"), "Tweety", Arrays.asList("url11", "url12"), Arrays.asList(new Tag(11, "tag11"), new Tag(12, "tag12")), "available"),
                new Pet(7, new Category(3, "Birds"), "Polly", Arrays.asList("url13", "url14"), Arrays.asList(new Tag(13, "tag13"), new Tag(14, "tag14")), "available"),
                new Pet(8, new Category(4, "Rabbits"), "Bugs", Arrays.asList("url15", "url16"), Arrays.asList(new Tag(15, "tag15"), new Tag(16, "tag16")), "available"),
                new Pet(9, new Category(4, "Rabbits"), "Thumper", Arrays.asList("url17", "url18"), Arrays.asList(new Tag(17, "tag17"), new Tag(18, "tag18")), "available"),
                new Pet(10, new Category(5, "Fish"), "Nemo", Arrays.asList("url19", "url20"), Arrays.asList(new Tag(19, "tag19"), new Tag(20, "tag20")), "available")
        };
        for (Pet pet : pets) {
...
//    @Consumes(MediaType.TEXT_PLAIN)
    ...
    public Response Category(@PathParam("id") int id) {
       ...
       List<Pet> cPet = new ArrayList<>();
        //dump all data that contain this category
        for (Map.Entry<Integer, Pet> entry : petsById.entrySet()) {
